...
Works locally AND on Render (handles read-only filesystem using /tmp).
...
DATA_DIR      = "/tmp/studyhub/data"    if IS_RENDER else "data"
UPLOAD_FOLDER = "/tmp/studyhub/uploads" if IS_RENDER else os.path.join("static", "uploads", "notes")
